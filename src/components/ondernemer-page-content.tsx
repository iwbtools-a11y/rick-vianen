...
import { CalendlyPopupCta } from "@/components/calendly-popup-cta";

/**
 * On the "site" variant this navigates to /intake (full page, full site chrome).
 * On the "landing" variant it opens Calendly in a popup instead, so an ad visitor
 * never leaves the nav-free page just to book a call.
 */
function BookCallCta({
  ...
  if (variant === "landing") {
    return <CalendlyPopupCta className={className}>{children}</CalendlyPopupCta>;
  }
  return (
...
export function OndernemerPageContent({
  variant = "site",
}: {
  /** "site" renders with the fixed navbar's offset; "landing" is nav-free (ad landing pages). */
  variant?: "site" | "landing";
}) {
  return (
    <div className="pb-24 md:pb-0">
      {/* ===== HERO ===== */}
      <section className={`gradient-hero px-8 md:px-16 pb-24 relative overflow-hidden ${variant === "landing" ? "pt-16 md:pt-20" : "pt-44"}`}>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-12 items-center relative">
          <div className="flex-1">
            <span className="inline-block px-3 py-1 bg-secondary-container/80 text-on-secondary-container font-bold text-xs uppercase tracking-widest rounded-full mb-6 backdrop-blur-sm">
              Peer-Group Traject &middot; 100 dagen &middot; Voor de gezonde ondernemer
            </span>
            <h1 className="font-[family-name:var(--font-headline)] text-5xl md:text-7xl font-black tracking-tighter leading-[1.05] mb-8">
              Je bedrijf groeit.<br />
              <span className="text-primary">Maar jouw energie holt achteruit.</span>
            </h1>
            <p className="text-base md:text-lg font-medium text-on-surface-variant max-w-xl">
              Je bedrijf gaat vooruit, maar je staat zelf stil. Je schuift sporten steeds voor je uit, voelt je minder energiek voor je gezin, je vrienden en leuke dingen naast werk. Herkenbaar?
            </p>
      ...
      {/* ===== VOOR WIE ===== */}
      <section id="voor-wie" className="py-24 px-8 md:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="font-[family-name:var(--font-headline)] text-4xl md:text-5xl font-black tracking-tight mb-8">
                5 signalen dat MOVE bij je past
              </h2>
              <ul className="space-y-4">
                {[
                  "Je bedrijf goed draait, maar je energie op is",
                  "Merkt dat je gezondheid achteruit gaat, maar geen tijd hebt om het serieus aan te pakken",
                  "Weer wilt sporten of een sportdoel wilt halen, zoals een marathon of triathlon, zonder dat het je bedrijf kost",
                  "‘s Avonds geen energie meer over hebt voor je gezin, terwijl je dat wel wilt",
              ...
              <a
                href="https://wa.me/31620523549?text=Hoi%20Rick%2C%20ik%20heb%20een%20vraag%20over%20MOVE"
                target="_blank"
                rel="noopener noreferrer"
                className="mt-8 inline-flex items-center gap-2 text-primary font-bold group link-hover"
              >
                ...
                Stuur een appje als je vragen hebt
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl p-10 border border-outline-variant/10">
            ...
            <h3 className="font-[family-name:var(--font-headline)] text-3xl font-black tracking-tight mb-4">
              Je groeit niet alleen. <span className="text-primary">Je trekt op met mensen die precies hetzelfde doormaken.</span>
            </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl overflow-hidden flex flex-col">
              <div className="p-10 pb-6">
                ...
                <BookCallCta
                  variant={variant}
                  className="block text-center btn-secondary font-bold text-sm px-6 py-3.5 rounded-lg"
                >
                  Plan een gesprek
                </BookCallCta>
              </div>
            ...
            <div className="relative bg-white rounded-2xl shadow-xl lg:scale-[1.03] z-20 overflow-hidden flex flex-col border-2 border-primary/20">
              ...
              <div className="p-10 pb-6 pt-14">
                ...
                <BookCallCta
                  variant={variant}
                  className="block text-center btn-primary font-bold text-sm px-6 py-3.5 rounded-lg"
                >
                  Plan een gesprek
                </BookCallCta>
              </div>
            ...
            <div className="bg-white rounded-2xl overflow-hidden flex flex-col">
              <div className="p-10 pb-6">
                ...
                <BookCallCta
                  variant={variant}
                  className="block text-center border-2 border-on-surface text-on-surface font-bold text-sm px-6 py-3.5 rounded-lg hover:bg-on-surface hover:text-white transition-all duration-300"
                >
                  Plan een gesprek
                </BookCallCta>
              </div>
